...
def find_best_batch_size(fold, architecture):
    ...
    path = f"/mnt/disk023/lcedillo/Lead_Data/Search_B/architecture_{architecture}.out"
...
def lead_mlp(x, y, fold, best_architecture, best_batch_size, best_seed):
...
if __name__ == "__main__":
    ...
    lead_mlp(x, y, args.fold, search_space[best_architecture], best_batch_size, best_seed)
